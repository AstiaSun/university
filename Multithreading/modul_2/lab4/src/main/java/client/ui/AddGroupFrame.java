...
public class AddGroupFrame extends AddObjectFrame {
    ...
    public AddGroupFrame(Client client, Point parentLocation) {
        super("Add new group", client, parentLocation);
    }
    ...
    protected void submitChanges() {
        ...
        try {
            Group newGroup = Utilities.createGroup(0, name, faculty, course);
            client.addGroupToDatabase(newGroup);
