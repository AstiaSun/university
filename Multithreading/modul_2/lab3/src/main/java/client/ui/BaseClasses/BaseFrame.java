...
abstract class BaseFrame extends JFrame {
    ...
    protected void setLocationAccordingToParent(Point parentLocation) {
        int x = parentLocation.x + (MainFrame.WIDTH - WIDTH) / 2;
        int y = parentLocation.y + (MainFrame.HEIGHT - HEIGHT) / 2;
        setLocation(x, y);
    }
